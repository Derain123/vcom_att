...
// If using random initialization, you can also define RANDOMIZE_DELAY toXEPIC_P2E
...
`endif
  ...
  wire        _WIRE;	// @[TestHarness.scala:113:38]
  ...
  wire        _resetIBUF_O;	// @[TestHarness.scala:100:25]
  ...
  ClockGroup dutGroup (	// @[ClockGroup.scala:31:15]
    ...
    .auto_in_member_0_reset (~_harnessSysPLL_locked | _WIRE),	// @[PLLFactory.scala:78:{20,35}, TestHarness.scala:113:38, XilinxShell.scala:84:55]
  ...
  XilinxVCU118MIG mig (	// @[VCU118NewShell.scala:312:23]
    ...
    .io_port_sys_rst                 (_WIRE),	// @[TestHarness.scala:113:38]
