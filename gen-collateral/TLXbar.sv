...
module TLXbar(
  ...
  assign auto_in_d_bits_param = (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, Xbar.scala:310:24]
  assign auto_in_d_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_1 ? {1'h0, auto_out_1_d_bits_size} : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Mux.scala:27:73]
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 4'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 4'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
