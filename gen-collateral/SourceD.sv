  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        queue_io_enq_valid_REG = _RANDOM_2[4];	// @[Reg.scala:19:16, SourceD.scala:121:40]
        queue_io_enq_valid_REG_1 = _RANDOM_2[5];	// @[Reg.scala:19:16, SourceD.scala:121:32]
        s2_full = _RANDOM_2[6];	// @[Reg.scala:19:16, SourceD.scala:147:24]
        s2_valid_pb = _RANDOM_2[7];	// @[Reg.scala:19:16, SourceD.scala:148:28]
        ...
        s2_req_source = _RANDOM_2[28:25];	// @[Reg.scala:19:16]
        ...
        s3_full = _RANDOM_6[23];	// @[Reg.scala:19:16, SourceD.scala:190:24]
        s3_valid_d = _RANDOM_6[24];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        ...
        s3_req_source = _RANDOM_7[13:10];	// @[Reg.scala:19:16]
        ...
        s4_full = _RANDOM_11[7];	// @[Reg.scala:19:16, SourceD.scala:248:24]
        ...
        s3_bypass_data_REG = _RANDOM_27[23];	// @[Reg.scala:19:16, SourceD.scala:337:19]
        s3_bypass_data_REG_1 = {_RANDOM_27[31:24], _RANDOM_28, _RANDOM_29[23:0]};	// @[Reg.scala:19:16, SourceD.scala:337:66]
      `endif // RANDOMIZE_REG_INIT
    end // initial
