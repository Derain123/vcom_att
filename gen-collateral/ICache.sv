...
module ICache(
  ...
  wire [127:0] _s1_vb_T_1 = vb_array >> io_s1_paddr[10:6];	// @[ICache.scala:440:25, :500:25, :850:21]
  assign s1_tag_hit_0 = _s1_vb_T_1[0] & _tag_array_RW0_rdata[20:0] == io_s1_paddr[31:11];	// @[DescribedSRAM.scala:17:26, ICache.scala:485:30, :500:25, :506:{26,33}, package.scala:155:13]
  wire [127:0] _s1_vb_T_5 = vb_array >> {123'h1, io_s1_paddr[10:6]};	// @[ICache.scala:440:25, :500:25, :850:21]
  assign s1_tag_hit_1 = _s1_vb_T_5[0] & _tag_array_RW0_rdata[42:22] == io_s1_paddr[31:11];	// @[DescribedSRAM.scala:17:26, ICache.scala:485:30, :500:25, :506:{26,33}, package.scala:155:13]
  wire [127:0] _s1_vb_T_9 = vb_array >> {123'h2, io_s1_paddr[10:6]};	// @[ICache.scala:440:25, :500:25, :850:21]
  assign s1_tag_hit_2 = _s1_vb_T_9[0] & _tag_array_RW0_rdata[64:44] == io_s1_paddr[31:11];	// @[DescribedSRAM.scala:17:26, ICache.scala:485:30, :500:25, :506:{26,33}, package.scala:155:13]
  wire [127:0] _s1_vb_T_13 = vb_array >> {123'h3, io_s1_paddr[10:6]};	// @[ICache.scala:440:25, :500:25, :850:21]
  assign s1_tag_hit_3 = _s1_vb_T_13[0] & _tag_array_RW0_rdata[86:66] == io_s1_paddr[31:11];	// @[DescribedSRAM.scala:17:26, ICache.scala:485:30, :500:25, :506:{26,33}, package.scala:155:13]
  assign data_arrays_0_MPORT_1_en = refill_one_beat & ~invalidated;	// @[ICache.scala:359:24, :383:41, :562:{32,35}]
  wire [7:0]   _GEN = {refill_paddr[10:6], 3'h0} | refill_cnt[7:0];	// @[Edges.scala:234:25, ICache.scala:566:{40,67}, :850:21, Reg.scala:19:16]
  ...
  wire [127:0] _vb_array_T_3 = 128'h1 << {121'h0, _repl_way_v0_prng_io_out_1, _repl_way_v0_prng_io_out_0, refill_paddr[10:6]};	// @[ICache.scala:444:32, :850:21, PRNG.scala:91:22, Reg.scala:19:16]
  ...
  always @(posedge clock) begin
    ...
    if (s1_valid) begin	// @[ICache.scala:333:25]
      ...
      s2_tl_error <= |{s1_tag_hit_3 & _tag_array_RW0_rdata[87], s1_tag_hit_2 & _tag_array_RW0_rdata[65], s1_tag_hit_1 & _tag_array_RW0_rdata[43], s1_tag_hit_0 & _tag_array_RW0_rdata[21]};	// @[DescribedSRAM.scala:17:26, ICache.scala:506:26, :510:32, :607:{43,50}, Reg.scala:19:16, package.scala:155:13]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vb_array = {_RANDOM_4[31:4], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8[3:0]};	// @[Edges.scala:229:27, ICache.scala:440:25]
        s2_tag_hit_0 = _RANDOM_9[17];	// @[Reg.scala:19:16]
        s2_tag_hit_1 = _RANDOM_9[18];	// @[Reg.scala:19:16]
        s2_tag_hit_2 = _RANDOM_9[19];	// @[Reg.scala:19:16]
        s2_tag_hit_3 = _RANDOM_9[20];	// @[Reg.scala:19:16]
        s2_dout_0 = {_RANDOM_9[31:21], _RANDOM_10[20:0]};	// @[Reg.scala:19:16]
        s2_dout_1 = {_RANDOM_10[31:21], _RANDOM_11[20:0]};	// @[Reg.scala:19:16]
        s2_dout_2 = {_RANDOM_11[31:21], _RANDOM_12[20:0]};	// @[Reg.scala:19:16]
        s2_dout_3 = {_RANDOM_12[31:21], _RANDOM_13[20:0]};	// @[Reg.scala:19:16]
        s2_tag_disparity_r_0 = _RANDOM_13[21];	// @[Reg.scala:19:16]
        s2_tag_disparity_r_1 = _RANDOM_13[22];	// @[Reg.scala:19:16]
        s2_tag_disparity_r_2 = _RANDOM_13[23];	// @[Reg.scala:19:16]
        s2_tag_disparity_r_3 = _RANDOM_13[24];	// @[Reg.scala:19:16]
        s2_tl_error = _RANDOM_13[25];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  tag_array_0 tag_array (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (tag_array_MPORT_en ? refill_paddr[10:6] : _tag_rdata_T_4),	// @[DescribedSRAM.scala:17:26, ICache.scala:391:37, :418:42, :850:21, Reg.scala:19:16]
    ...
    .RW0_wdata ({refillError, refill_paddr[31:11], refillError, refill_paddr[31:11], refillError, refill_paddr[31:11], refillError, refill_paddr[31:11]}),	// @[DescribedSRAM.scala:17:26, ICache.scala:380:33, :422:43, Reg.scala:19:16]
  ...
  data_arrays_0 data_arrays_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _GEN : io_req_bits_addr[10:3]),	// @[ICache.scala:383:41, :557:31, :566:{10,67}]
  ...
  assign io_resp_bits_data = (s2_tag_hit_0 ? s2_dout_0 : 32'h0) | (s2_tag_hit_1 ? s2_dout_1 : 32'h0) | (s2_tag_hit_2 ? s2_dout_2 : 32'h0) | (s2_tag_hit_3 ? s2_dout_3 : 32'h0);	// @[Bundles.scala:260:74, Mux.scala:27:73, Reg.scala:19:16]
