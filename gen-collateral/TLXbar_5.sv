...
module TLXbar_5(
  ...
  wire        requestAIO_0_2 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[12]} == 6'h0 | {_GEN_0[5], _GEN_0[1:0], auto_in_a_bits_address[20], auto_in_a_bits_address[16]} == 5'h0;	// @[Arbiter.scala:113:44, Bundles.scala:260:74, Parameters.scala:137:{31,45,65}, Xbar.scala:366:92]
  wire        requestAIO_0_3 = {auto_in_a_bits_address[30], ~(auto_in_a_bits_address[26])} == 2'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_4 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25] ^ 2'h1, auto_in_a_bits_address[20], auto_in_a_bits_address[16]} == 5'h0;	// @[Bundles.scala:260:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_5 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], ~(auto_in_a_bits_address[16])} == 5'h0;	// @[Bundles.scala:260:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_6 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], ~(auto_in_a_bits_address[20]), auto_in_a_bits_address[12]} == 5'h0;	// @[Bundles.scala:260:74, Parameters.scala:137:{31,45,65}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[11:3]) : 9'h0) | {6'h0, (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0) | (winnerQual_2 & auto_out_2_d_bits_opcode[0] ? ~(_beatsDO_decode_T_9[5:3]) : 3'h0) | (winnerQual_3 & auto_out_3_d_bits_opcode[0] ? ~(_beatsDO_decode_T_13[5:3]) : 3'h0) | (winnerQual_4 & auto_out_4_d_bits_opcode[0] ? ~(_beatsDO_decode_T_17[5:3]) : 3'h0) | (winnerQual_5 ? ~(_beatsDO_decode_T_21[5:3]) : 3'h0) | (winnerQual_6 & auto_out_6_d_bits_opcode[0] ? ~(_beatsDO_decode_T_25[5:3]) : 3'h0)};	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:260:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
      ...
      if (latch & (|readys_valid))	// @[Arbiter.scala:28:{18,27}, :90:24, Cat.scala:33:92]
        readys_mask <= _readys_mask_T_6 | {_readys_mask_T_6[2:0], 4'h0};	// @[Arbiter.scala:24:23, Bundles.scala:260:74, package.scala:245:{43,53}]
  ...
  assign auto_in_d_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_opcode : 3'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_opcode : 3'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_5} | (muxStateEarly_6 ? auto_out_6_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:260:74, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_1 ? {1'h0, auto_out_1_d_bits_size} : 4'h0) | (muxStateEarly_2 ? {1'h0, auto_out_2_d_bits_size} : 4'h0) | (muxStateEarly_3 ? {1'h0, auto_out_3_d_bits_size} : 4'h0) | (muxStateEarly_4 ? {1'h0, auto_out_4_d_bits_size} : 4'h0) | (muxStateEarly_5 ? {1'h0, auto_out_5_d_bits_size} : 4'h0) | (muxStateEarly_6 ? {1'h0, auto_out_6_d_bits_size} : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:260:74, Mux.scala:27:73]
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 5'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 5'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 5'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 5'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 5'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 5'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_source : 5'h0);	// @[Arbiter.scala:118:30, Bundles.scala:260:74, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 64'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_data : 64'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_data : 64'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_data : 64'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_data : 64'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:260:74, Mux.scala:27:73]
