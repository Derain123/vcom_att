...
module TLBuffer(
  ...
  wire [2:0] _x1_a_q_io_deq_bits_param;	// @[Decoupled.scala:375:21]
  wire       _x1_a_q_io_deq_bits_corrupt;	// @[Decoupled.scala:375:21]
  Queue_VCU118FPGATestHarness_UNIQUIFIED x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_deq_bits_param   (_x1_a_q_io_deq_bits_param),
    .io_deq_bits_size    (auto_out_a_bits_size),
    .io_deq_bits_source  (auto_out_a_bits_source),
    .io_deq_bits_address (auto_out_a_bits_address),
    .io_deq_bits_mask    (auto_out_a_bits_mask),
    .io_deq_bits_data    (auto_out_a_bits_data),
    .io_deq_bits_corrupt (_x1_a_q_io_deq_bits_corrupt)
  );
