...
module TLXbar_4(
  ...
  assign auto_in_0_d_valid = auto_out_d_valid & ~(auto_out_d_bits_source[4]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  ...
  assign auto_out_a_bits_size = (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0) | {2'h0, muxStateEarly_1, 1'h0};	// @[Arbiter.scala:26:66, :118:30, Bundles.scala:260:74, Mux.scala:27:73]
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 5'h0) | {muxStateEarly_1, 4'h0};	// @[Arbiter.scala:118:30, Bundles.scala:260:74, Mux.scala:27:73, Xbar.scala:240:29, :265:23]
  assign auto_out_a_bits_address = (muxStateEarly_0 ? auto_in_0_a_bits_address : 31'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_address : 31'h0);	// @[Arbiter.scala:118:30, Bundles.scala:260:74, Mux.scala:27:73]
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 8'h0) | (muxStateEarly_1 ? 8'hF : 8'h0);	// @[Arbiter.scala:118:30, Bundles.scala:260:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = (muxStateEarly_0 ? auto_in_0_a_bits_data : 64'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:260:74, Mux.scala:27:73]
