...
module L1MetadataArray(
  input         clock,
                reset,
                io_read_valid,
  input  [3:0]  io_read_bits_idx,
  input         io_write_valid,
  input  [3:0]  io_write_bits_idx,
                io_write_bits_way_en,
  input  [1:0]  io_write_bits_data_coh_state,
  input  [21:0] io_write_bits_data_tag,
  output        io_read_ready,
                io_write_ready,
  output [1:0]  io_resp_0_coh_state,
  output [21:0] io_resp_0_tag,
  output [1:0]  io_resp_1_coh_state,
  output [21:0] io_resp_1_tag,
  output [1:0]  io_resp_2_coh_state,
  output [21:0] io_resp_2_tag,
